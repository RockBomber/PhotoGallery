...
public class ThumbnailDownloader<T> extends HandlerThread {
    ...
    public void queueThumbnail(T targer, String url) {
        Log.i(TAG, "Got a URL: " + url);

        if (url == null) {
            mRequestMap.remove(targer);
        } else {
            mRequestMap.put(targer, url);
            mRequestHandler.obtainMessage(MESSAGE_DOWNLOAD, targer).sendToTarget();
        }
    }
